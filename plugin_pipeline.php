...
JS;
    ...
    public function cron_mit_report() {
        ...
        $summary = $ctx['summary'];
        $prompt = "Eres MIT, un asistente de reclutamiento para energía renovable. Comienza con un tono juguetón y ofrece un consejo positivo para iniciar el día. Con los siguientes datos: $summary Genera un informe con recomendaciones y sugerencias. Devuelve la respuesta en HTML usando <h3> para títulos de sección, <ul><li> para listas, <blockquote> para plantillas de correo, <strong> para nombres o roles importantes y separa secciones con <hr>.";
