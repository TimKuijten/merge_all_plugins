...
class KT_AIBulkMailer_ES {
    ...
    public function submenu_icon() {
        echo '<style>#toplevel_page_kovacic .wp-submenu a[href="admin.php?page=kt-abm"]:before{content:"\\f466";font-family:dashicons;margin-right:6px;}</style>';
    }
    ...
    public function enqueue($hook) {
        $is_main = $hook === 'toplevel_page_kt-abm';
        $is_sent = $hook === 'kt-abm_page_kt-abm-sent';
